...
// start
function increase_size(id) {
  id.style.height = "40px"; // Set height to 100%
  id.style.width = "120px"; // Set width to 100%

}
function normal_size(id) {
  id.style.height = "35px"; // Set height to 100%
  id.style.width = "110px"; // Set width to 100%
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function addAnimationClass() {
      elements.forEach(function(element) {
        element.classList.add('slide-fwd-center');
      });
    }
